"""
VC MusXmarty Player, Telegram Voice Chat Userbot
...
buttons = [
    [
        InlineKeyboardButton('🏃 Deploy to Heroku 🏃', url='https://heroku.com/deploy?template=https://github.com/S780821/XMARTY_MUSIC_4'),
    ],
    [
